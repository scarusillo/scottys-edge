...
```
Summarize any action items from the briefing AND the agent reports before the user asks. The 3 cloud agents run together each morning: Morning Briefing (5:30am), Pre-Run Validator (5:35am), Code Auditor (5:40am). Reports land via `git pull`.
